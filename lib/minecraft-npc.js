...
class MinecraftNpc {
  ...
  async start(cb) {
    ...
    _bot.chatgpt.setConfig({
      ...
      minimumReplyConfidenceScore: _opts.chatGptMinimumReplyConfidenceScore,
      minimumJailbreakConfidenceScore:
        _opts.chatGptMinimumJailbreakConfidenceScore,
    ...
    _bot.once("spawn", () => {
      ...
      if (_opts.autoModeEnabled) {
        this.npc.enableAutoMode(_opts.autoModeEngine);
      }
