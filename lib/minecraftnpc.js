...
import InitLocation from './actions/init_location.js';
import InitMessage from './actions/init_message.js';
...
class MinecraftNpc {
  ...
  async start(cb) {
    ...
    bot.once('spawn', () => {
      ...
      new InitLocation(self.register, bot).do({
        coordX: coordX,
        coordY: coordY,
        coordZ: coordZ
      });

      new InitMessage(self.register, bot).do({
