...
import action_init_location from './actions/init_location.js';
import action_init_message from './actions/init_message.js';
...
class MinecraftNpc {
  ...
  async start(cb) {
    ...
    bot.once('spawn', () => {
      ...
      action_init_location(bot, coordX, coordY, coordZ);

      action_init_message(bot, self.initMessage);
